...
public class BlockItems {
    ...
    public enum Plate implements IItemProvider {
        ...
        SILVER("Ag"),
        STEEL("Fe"),
        STAINLESS_STEEL(Ingot.STAINLESS_STEEL.description),
    ...
    public enum Smalldust implements IItemProvider {
        ...
        QUARTZ(Dust.QUARTZ.description),
    ...
    public enum Component implements IOreDictItemProvider {
        ...
        INTEGRATED_CIRCUIT(ItemIntegratedCircuit::new, "circuitIntegrated");
